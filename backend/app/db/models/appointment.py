...
class AppointmentModel(Base):
    ...
    # Relationships
    patient = relationship("UserModel", foreign_keys=[patient_id], backref="patient_appointments")
    doctor = relationship("UserModel", foreign_keys=[doctor_id], backref="doctor_appointments")