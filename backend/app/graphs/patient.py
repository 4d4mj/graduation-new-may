...
def create_patient_graph() -> StateGraph:
    ...
    2. Run medical agent (handles intent recognition, tool selection, and execution automatically)
    ...
    logger.info("Patient graph created with unified medical agent architecture")
    return g
